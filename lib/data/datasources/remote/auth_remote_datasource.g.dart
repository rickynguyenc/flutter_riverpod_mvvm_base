...
class _AuthService implements AuthService {
  ...
  @override
  Future<LoginResponseDto> login(Map<String, dynamic> param) async {
  ...
  Future<dynamic> forgotPassword(Map<String, dynamic> data) async {
    ...
    final _options = _setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/app/global-lookup-table/send-password-reset-code',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<dynamic> checkMailExist(Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/app/global-lookup-table/check-email-exits',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<dynamic> changePassword(Map<String, dynamic> data) async {
    ...
    final _options = _setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/app/user-profile/change-password',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
